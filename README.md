...
mindmap
  Biotecnología
    Definición
      "Ciencia multidisciplinaria que utiliza sistemas biológicos y organismos vivos"
      "Aplica conocimientos de biología, química, genética y otras áreas"
    "Aportes en la antigüedad"
      Agricultura
        "Domesticación de plantas y animales"
        "Selección de variedades con características deseadas"
      Alimentos
        "Fermentación de alimentos pan, cerveza, vino, queso"
        "Uso de microorganismos para conservar alimentos"
      Medicina
        "Uso de plantas medicinales"
        "Conocimiento empírico sobre propiedades curativas"
    "Ingeniería genética y ADN recombinante"
      Características
        "Aislamiento y manipulación de fragmentos de ADN"
        "Introducción de ADN recombinante en organismos"
